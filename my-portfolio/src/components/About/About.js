...
function About() {
  return(
    <p>With a recent graduation from an intensive web development course that earned me a Bac +2 degree, I've laid a solid foundation for my journey into the digital realm. 
